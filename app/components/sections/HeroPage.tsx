  ...
  return (
    <>
      ...
      <div style={{ overflow: "hidden" }}>
        ...
        {/* HERO */}
        <div style={{ position: "relative", height: "100vh", width: "100%", marginTop: "72px", zIndex: 0 }}>
          <img
            src="/images/hero.jpg"
            alt="Hero"
          ...
          {/* BANDEAU EN BAS DU HERO */}
          <div style={{ position: "absolute", bottom: "7rem", left: 0, right: 0, zIndex: 10, padding: "0 clamp(1rem, 5vw, 50px)" }}>
            <div style={{
        ...
        {/* CARROUSEL */}
        <main style={{ maxWidth: "100%", position: "relative", zIndex: 2 }}>
